...
def get_config():
    ...
    #parser.add_argument("--device", type=cuda, default=1)
    ...
    parser.add_argument("--num_predator", type=int, default=1)
    ...
    parser.add_argument('--advvel', type=float, default=0.1, help="velocity of adversaries")
    parser.add_argument('--preyvel', type=float, default=0.6, help="velocity of prey")
    ...
    parser.add_argument("--use_attn", action='store_true', 
                        default=False, help='Whether agent use attn policy')
    parser.add_argument("--att_hidden", type=int, default=128,
                        help="Dimension of hidden layers for attn networks")
    parser.add_argument("--est_gama", type=float, default=0.1,
                        help="Gamma of est weight in loss")
    parser.add_argument("--comm_dis", type=float, default=20,
