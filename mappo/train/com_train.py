...
class Cons_net:
    ...
    def train(self):
        ...
        for episode in range(self.episodes):
            ...
            loss_a += np.array(loss.cpu().data)
            loss_ae += np.array(loss_e.cpu().data)
    ...
    def save_model(self):
        """Save networks."""
        #print(str(self.save_dir))
        th.save(self.kd_network.state_dict(), str(self.save_dir) + "/cons_kd_cl3.pt")
        th.save(self.actor.state_dict(), str(self.save_dir) + "/act_kd_cl3.pt")
